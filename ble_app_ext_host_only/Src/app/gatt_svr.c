                                     ...
                                     void *arg)
{
    ...
    if (!csc_cp_indication_status) {
        printf("SC Control Point; CCC descriptor "
    ...
    printf("SC Control Point; opcode=%d\n", op_code);
    ...
    case SC_CP_OP_SET_CUMULATIVE_VALUE:
        ...
        printf("SC Control Point; Set cumulative value = %d\n",
                    measurement_state->cumulative_wheel_rev);
    ...
    case SC_CP_OP_UPDATE_SENSOR_LOCATION:
        ...
        printf("SC Control Point; Sensor location update = %d\n",
                    new_sensor_location);
