...
#define BLE_SVC_GAP_PPCP_ENABLED        MYNEWT_VAL(BLE_ROLE_PERIPHERAL) && (MYNEWT_VAL(BLE_SVC_GAP_PPCP_MIN_CONN_INTERVAL) || \
...
static char     ble_svc_gap_name[BLE_SVC_GAP_NAME_MAX_LEN + 1]  = MYNEWT_VAL(BLE_SVC_GAP_DEVICE_NAME);
